...
//
// The parser lives in `./cip108` (a CSL-free module) so lean consumers can
// import it without pulling in this file's heavy import graph. Imported here
// for internal use AND re-exported for backwards compatibility with existing
// importers of `parseCip108Body` / `ParsedCip108` from this module.
export { parseCip108Body, type ParsedCip108 } from './cip108';

...
//
// Pure rendering math for the DRep concentration donut. Mirrors the
// backend's `lib/dreps/concentrationView.ts` so the frontend doesn't have
// to import server types; the math is small and JSON-shaped responses
// from `GET /dreps/concentration` plug directly into these helpers.
